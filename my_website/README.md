...
###### ГОТОВИМ ПРОЕКТ ДЛЯ ОЛИМПИАДЫ. РАБОТА С GITHUB И РЕДАКТИРОВАНИЕМ КОДА

**Автор:** Юрий Викторович
**Классы:** 6–11
**Дедлайн:** 20 апреля — олимпиада
**Время урока:** 15 минут

Вот **статья-урок для ВК-сообщества**, написанная по нашему стриму. Она оформлена как практическое занятие: с  живыми диалогами, скриншотами действий и готовыми кодами. Подходит для  публикации в паблике школы, кружка по программированию или  личного блога.

> «Когда ты готов — стрим всегда будет не более 15-20 минут. Наш стрим — это короткий мозговой штурм».
> *(цитата из стрима)*
...
Мы готовимся к олимпиаде. Основные навыки, которые пригодятся 20 апреля:

- регистрация и работа с **GitHub**
- скачивание готового шаблона сайта-визитки
- распаковка, перенос на рабочий стол
- открытие `index.html` в браузере
- редактирование кода (замена данных «Ивана Иванова» на свои данные)
- сохранение и проверка изменений
- восстановление шаблона, если что-то сломалось

------

###### 📌 ШАГ 1. РЕГИСТРАЦИЯ НА GITHUB

> «Мы просто регистрировались на GitHub. Ребята уже все зарегистрировались. Жан зарегистрирован».

✅ Что делаем:

- заходим на [github.com](https://github.com)
- нажимаем **Sign up**
- вводим почту, пароль, имя пользователя
- подтверждаем регистрацию

> «Вот у него уже есть задел, обещал наберать команду.».
> *(Жан — наш будующий тимлит!)*

------

###### 📌 ШАГ 2. СКАЧИВАЕМ ШАБЛОН

> Заходим в мой репозиторий https://github.com/yuratokazin
>
> «... и скачиваем всю эту папку».

🔽 Инструкция:

1. Переходим в репозиторий с шаблоном https://github.com/yuratokazin/Lessons
2. Нажимаем зелёную кнопку **Code**
3. Выбираем **Download ZIP**
4. Ждём завершения закачки

------

###### 📌 ШАГ 3. РАСПАКОВЫВАЕМ И ПЕРЕНОСИМ

> «Теперь скачанный файл можно открыть с помощью архиватора, и распаковать. По умолчанию скачанный архивный файл попадает в папку "Загрузки", находим его там и нажимаем распаковать».

📂 Действия:

- находим скачанный ZIP-файл - `Lessons-main.zip`
- распаковываем (ПКМ → «Извлечь всё»)
- получаем папку без `.zip` - `Lessons-main`
- в папке `Lessons-main` находим папку `my_website`
- копируем её **на рабочий стол** - берем левой кнопкой и переносим на свободное пространство **рабочего стола** 

> «Если что-то испортили во время кодинга — просто заходите опять в мою папку, скачивайте и всё обновляете».

------

###### 📌 ШАГ 4. ОТКРЫВАЕМ И ПРОВЕРЯЕМ

> «Нажимаем правой кнопкой на index.html → открыть с помощью → браузер».

🌐 Что видим:

- заголовок «Иван Иванов»
- школа №3, Гусиноозерск
- секции: Обо мне, Навыки, Проекты

> «Это пример: далее Иван Иванов меняем на свои имя и фамилию, а так же все остальные данные мы будем менять в дальнейшем».

------

###### 📌 ШАГ 5. РЕДАКТИРУЕМ КОД

> «Теперь наша задача — найти и поменять всё, что связано со старыми данными на свои».
...
```
<!-- Было -->
<p>Ученик 8 «Б» класса, СОШ №3</p>

<!-- Стало (пример для педагога) -->
<p>Педагог дополнительного образования, программист</p>
```



> «Я написал: "Юрий Таказин, педагог дополнительного образования ...". А вы пишите свои данные».

------

###### 📌 ШАГ 6. СОХРАНЯЕМ И ПРОВЕРЯЕМ

> «Нажимаем сохранить обязательно, потому что мы изменили код уже внутри готового шаблона».

💾 Важно:

- после каждого изменения → **Ctrl+S** 
- переходим в браузер → **обновить страницу** (F5)
- смотрим: изменилось или нет?

> «Теперь вы увидите что и как изменилось у вас в браузере».

------

###### 🧠 ВАЖНОЕ НАБЛЮДЕНИЕ С УРОКА

> «У меня новенький ученик Никита, проявил способности с первого занятия, иногда он быстрее меня  находил теги где нам нужно было менять текст. Жан так же, часто опережал меня. Ученики всегда должны превосходить учителя. Молодцы!»

🔍 **Никита заметил то, что учитель пропустил.**
Это признак:

- хорошей памяти
- внимательности
- умения видеть детали
...
> «Не знаете, как восстановить? Заходите опять в мою папку, скачивайте и всё обновляете».

Алгоритм восстановления:

1. Скачать свежий ZIP из репозитория
2. Распаковать
3. Скопировать папку на рабочий стол
4. Нажать «Заменить все файлы»
5. Продолжить работу

------

###### 🎯 ДОМАШНЕЕ ЗАДАНИЕ (ДО СЛЕДУЮЩЕГО СТРИМА)

> «Теперь вы сами дерзаете, что бы на следующем занятии мы уже ознакомились с содержанием ваших сайтов и приступили к узменению дизайна ваших сайтов.».

✅ Что нужно сделать:

- заменить все данные «Ивана Иванова» на свои данные
- поменять фото (пока заглушка)
- изменить описание достижений под себя
- подготовить вопросы по дизайну
...
- менять **кнопки**
- править **надписи**
- готовить **финальный слив**

------

###### ⏱️ СЕКРЕТ 15 МИНУТ

> «За сколько мы вложились? За 15 минут. Когда вы готовы — стримы всегда будут не больше 15-20 минут».

**Почему получилось быстро?**

- всё было подготовлено заранее
- шаблон уже лежал на GitHub
- ребята заранее зарегистрировались
- код был готов к правке

> «Научно говорю — это всё».
...
| Что                     | Куда                                            |
| ----------------------- | ----------------------------------------------- |
| Регистрация GitHub      | [github.com](https://github.com)                |
| Скачать шаблон          | ссылка в репозитории (в закреплённом сообщении) |
| Архиватор (для Windows) | 7-Zip / WinRAR                                  |
| Редактор кода           | Блокнот / VS Code / Notepad++                   |

------

###### 💬 ЗАКЛЮЧЕНИЕ ОТ АВТОРА СТРИМА

> «Ребята, я закончил стрим. До свидания, спасибо за внимание. Тренируйте внимательность».

📢 **Подпишитесь на сообщество**, чтобы не пропустить следующий стрим.
Там будем:

- менять дизайн
- настраивать кнопки
- делать финальную версию перед олимпиадой

------

###### 📝 КОММЕНТАРИЙ ДЛЯ УЧАСТНИКОВ

А вы не нашли в этом уроке ответы на ваши вопросы?
Напишите в комментариях 👇

**Следующий стрим:** в понедельник в 9:00
**Тема:** Дизайн, цвета, кнопки — готовимся к олимпиаде

------

*Статья создана на основе реального стрима. Сохранены все ключевые моменты, диалоги и интонации автора.*
